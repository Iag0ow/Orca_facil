...
import { getProduct, getProductsByOrc, updateProduct } from "../../../utils/Config";
...
const Orcamento = () => {
  ...
  useEffect(() => {
      ...
      setProducts(await getProductsByOrc(category));
    }
    fetchData();
  }, [updated]);
    ...
    <>
      ...
      <div className="container mt-5 p-4 bg-white">
        <div className=" table-itens">
          <h1 className="text-center title-orc">Criar Orçamento</h1>
          <h1 className="text-center">Marque os produtos para o orçamento</h1>
